#!/usr/bin/python3
"""
The route for handling Amenity objects & operations.
"""
...
def amenity_by_id(amenity_id):
    ...
    :return: state obj with the specified id/error
    """
...
def amenity_put(amenity_id):
    ...
    :param amenity_id: amenity object ID
    :return: amenity object & 200 on success, or 400/404 on failure
    """
    am_json = request.get_json(silent=True)
    if am_json is None:
        abort(400, 'Not a JSON')
