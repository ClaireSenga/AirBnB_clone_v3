#!/usr/bin/python3
"""
route for handling State objects & operations
"""
...
def city_by_state(state_id):
    ...
    :return: json of all cities in a state/404 on error
    """
    city_list = []
...
def city_put(city_id):
    ...
    :param city_id: city object ID
    :return: city object & 200 on success, or 400/404 on failure
    """
    city_json = request.get_json(silent=True)
    if city_json is None:
        abort(400, 'Not a JSON')
...
def city_delete_by_id(city_id):
    ...
    deletes City by id
    :param city_id: city object id
    :return: empty dict with 200/404 if not found
    """
